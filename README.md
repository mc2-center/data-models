...
4. When ready to release a new version of the data model (see below) and a pull request is made, the valid values will automatically get added to the mc2.model.csv and the jsonld.
