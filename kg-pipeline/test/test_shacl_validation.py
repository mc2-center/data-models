...
# One fixture per shape, each with exactly one violation. Checking
# sh:sourceShape (not just conforms=False) stops a fixture passing because
# some other shape fired.
